...
namespace Other
{
    internal class UpdateManager
    {
        ...
        public async Task CheckForUpdate(string currentVersion)
        {
            ...
            var (latestVersion, latestZipUrl) = await githubManager.GetLatestReleaseInfo("Babyhamsta", "VoidShot");
        ...
        private async Task DoUpdate(string latestZipUrl)
        {
            ...
            string localZipPath = Path.Combine(envTempPath, "VoidShotUpdate.zip");
            ...
            string extractPath = Path.Combine(envTempPath, "VoidShotUpdate");
