            ...
            builder
                ...
                .AddSlider("AI Minimum Confidence", "% Confidence", 1, 1, 1, 100, s =>
                {
                    ...
                    s.Slider.PreviewMouseLeftButtonUp += (sender, e) =>
                    {
                        ...
                        if (value >= 95)
                            LogManager.Log(LogLevel.Warning, "The minimum confidence you have set for VoidShot to be too high and may be unable to detect players.", true);
                        else if (value <= 35)
                            LogManager.Log(LogLevel.Warning, "The minimum confidence you have set for VoidShot may be too low can cause false positives.", true);
                    };
