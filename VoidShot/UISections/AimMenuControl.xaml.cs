using VoidShot.AILogic;
using VoidShot.Class;
using VoidShot.MouseMovementLibraries.GHubSupport;
using VoidShot.UILibrary;
using Class;
using InputLogic;
                    ...
                    s.Slider.PreviewMouseLeftButtonUp += (sender, e) =>
                    {
                        ...
                        if (value >= 0.98)
                            LogManager.Log(LogManager.LogLevel.Warning,
                                "The Mouse Sensitivity you have set can cause VoidShot to be unable to aim, please decrease if you suffer from this problem", true);
                        else if (value <= 0.1)
                            LogManager.Log(LogManager.LogLevel.Warning,
                                "The Mouse Sensitivity you have set can cause VoidShot to be unstable to aim, please increase if you suffer from this problem", true);
                    };
